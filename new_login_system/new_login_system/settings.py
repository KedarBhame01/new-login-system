"""
Django settings for new_login_system project.
...
ALLOWED_HOSTS = ['*', '192.168.0.207', '192.168.0.208', 'localhost']
...
ROOT_URLCONF = 'new_login_system.urls'
...
WSGI_APPLICATION = 'new_login_system.wsgi.application'
...
REST_FRAMEWORK = {
    ...
    'SEARCH_PARAM': 'search',   # optional: rename the query param
}
